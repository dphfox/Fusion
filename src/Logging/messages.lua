...
return {
	...
	destroyedTwice = "Attempted to destroy %s twice; ensure you're not manually calling `:destroy()` while using scopes. See discussion #xxx on GitHub for advice.",
	...
	possiblyOutlives = "%s will be destroyed before %s; try swapping the order of creation. See discussion #xxx on GitHub for advice.",
	...
	useAfterDestroy = "%s is no longer valid - it was destroyed before %s. See discussion #xxx on GitHub for advice.",
}