...
return {
	...
	cannotYield = "Attempted to yield in a synchronous thread.",
	computedCallbackError = "Computed callback error: ERROR_MESSAGE",
	computedCannotYield = "Cannot yield inside a Computed callback function.",
	computedPairsCannotYield = "Cannot yield inside a ComputedPairs processor function.",
