...
return {
	...
	computedNoCachedValue = "Computed hasn't cached its value yet; this could be an expensive call.",
	forKeysNoCachedValue = "ForKeys hasn't cached its value yet; this could be an expensive call.",
	forValuesNoCachedValue = "ForValues hasn't cached its value yet; this could be an expensive call.",
	forPairsNoCachedValue = "ForPairs hasn't cached its value yet; this could be an expensive call.",
